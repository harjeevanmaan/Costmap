...
public:
    ...
    Costmap(const std::string map_name, const std::string pc_topic, const std::string cmap_topic,
            const float lower_thres, const float upper_thres, float inner_rad, float outer_rad);
